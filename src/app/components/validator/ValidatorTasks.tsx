...
export function ValidatorTasks() {
  ...
  return (
    <div className="min-h-screen pb-6" style={{ background: '#F8F9FA', fontFamily: 'var(--font-sans)' }}>
      ...
      {/* ── Title area ── */}
      <div className="px-6 pb-5" style={{ position: 'relative' }}>
        <div className="flex items-center gap-2 mb-1">
          <ShieldCheck className="w-4 h-4" style={{ color: '#1C2434' }} strokeWidth={2} />
        ...
        <div style={{ marginTop: 12, opacity: 0.10 }}>
          <Waveform color="#1C2434" opacity={1} height={28} variant="precision" />
        </div>
      </div>
            ...
            return (
              ...
              >
                ...
                <div className="flex-1">
                  <h4 style={{ fontSize: 15, fontWeight: 700, color: '#1C2434', marginBottom: 7 }}>
                    {task.title}
                  </h4>
                  ...
                  <div className="flex items-center gap-2 flex-wrap">
                    <span style={{
                      ...
                      background: pCfg.bg, color: pCfg.text,
                    }}>
                ...
                <div style={{
                  ...
                  <Play
                    className="w-5 h-5"
                    style={{ color: task.priority === 'High' ? '#FFFFFF' : '#1C2434' }}
                    fill={task.priority === 'High' ? '#FFFFFF' : '#1C2434'}
                  />
                </div>
              </div>
            );
